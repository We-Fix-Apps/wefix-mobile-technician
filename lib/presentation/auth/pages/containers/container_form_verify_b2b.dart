...
class ContainerFormVerifyB2B extends StatefulWidget with FormValidationMixin {
  final String mobile;
  final String? otp;
  ContainerFormVerifyB2B({super.key, required this.mobile, this.otp});

  @override
  State<ContainerFormVerifyB2B> createState() => _ContainerFormVerifyB2BState();
}

class _ContainerFormVerifyB2BState extends State<ContainerFormVerifyB2B> with FormValidationMixin {

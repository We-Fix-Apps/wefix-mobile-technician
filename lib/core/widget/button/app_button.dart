      ...
      builder:
          (_, __, ___) =>
              loading == true
                  ...
                  : Text(text, textAlign: TextAlign.center, style: textStyle ?? AppTextStyle.style14B.copyWith(color: AppColor.white)),
    );
  }
            ...
            children: [
              leadingIconAssetName != null
                  ? Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(leadingIconAssetName, color: AppColor.white, size: AppButtonIconSize.fromButtonHeights(height)),
                      const SizedBox(width: 8.0),
                    ],
                  )
                  : Container(),
              Text(text, textAlign: TextAlign.center, style: AppTextStyle.style14B),
              trailingIconAssetName != null
                  ? Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [8.gap, Icon(trailingIconAssetName, color: AppColor.white, size: AppButtonIconSize.fromButtonHeights(height))],
                  )
                  : Container(),
            ],
          ),
    ...
    return AppButton(
      ...
      builder:
          (_, __, ___) => Column(
            ...
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(icon, color: AppColor.white, size: iconSize ?? AppButtonIconSize.fromButtonHeights(height)),
              5.gap,
              Text(text, textAlign: TextAlign.center, style: textStyle ?? AppTextStyle.style14B),
            ],
          ),
    );
  }
      ...
      builder:
          (_, __, ___) =>
              iconPath != ''
                  ...
                  : Icon(iconAssetName, color: iconColor ?? AppColor.white, size: iconSize ?? AppButtonIconSize.fromButtonHeights(height)),
    );
  }

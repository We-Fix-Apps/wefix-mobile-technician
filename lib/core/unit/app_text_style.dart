...
abstract class AppTextStyle extends TextStyle {
  ...
  static TextStyle style8 = TextStyle(fontSize: lang == 'en' ? 8 : 11);
  static TextStyle style8B = TextStyle(fontSize: lang == 'en' ? 8 : 11, fontWeight: FontWeight.bold);
  static TextStyle style9 = TextStyle(fontSize: lang == 'en' ? 9 : 12);
  static TextStyle style9B = TextStyle(fontSize: lang == 'en' ? 9 : 12, fontWeight: FontWeight.bold);
  static TextStyle style10 = TextStyle(fontSize: lang == 'en' ? 10 : 14);
  static TextStyle style10B = TextStyle(fontSize: lang == 'en' ? 10 : 14, fontWeight: FontWeight.bold);
  static TextStyle style11 = TextStyle(fontSize: lang == 'en' ? 11 : 14);
  static TextStyle style11B = TextStyle(fontSize: lang == 'en' ? 11 : 14, fontWeight: FontWeight.bold);
  static TextStyle style12 = TextStyle(fontSize: lang == 'en' ? 12 : 15);
  static TextStyle style12B = TextStyle(fontSize: lang == 'en' ? 12 : 15, fontWeight: FontWeight.bold);
